  ...
  .private = list(
    ...
    drawItem = function(self, cr, style, item, grabbed) {
      ...
      if (grabbed) {
        ...
        gdkCairoSetSourceColor(cr, style$dark[[GtkStateType["active"] + 1]])
      }
      ...
      if (grabbed) {
        ...
        gdkCairoSetSourceColor(cr, style$base[[GtkStateType["normal"] + 1]])
      }
      ...
      cr$moveTo(
        x[item] - 1 - extents$width / 2 - extents$xBearing,
      ...
      if (grabbed) {
        ...
        gdkCairoSetSourceColor(cr, style$text[[GtkStateType["normal"] + 1]])
      }
...
puzzle_solved <- function(widget) {
  ...
  dialog <- gtkDialog(
    "GtkSlide - solved", parent, "modal", GTK_STOCK_OK,
