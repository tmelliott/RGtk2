...
cursor1_height <- 16
cursor1_bits <- c(
    0x80, 0x01, 0x40, 0x02, 0x20, 0x04, 0x10, 0x08, 0x08, 0x10,
...
cursor1mask_bits <- c(
    0x80, 0x01, 0xc0, 0x03, 0x60, 0x06, 0x30, 0x0c, 0x18,
...
source <- gdkBitmapCreateFromData(
    NULL, cursor1_bits,
    cursor1_width, cursor1_height
)
mask <- gdkBitmapCreateFromData(
    NULL, cursor1mask_bits,
    cursor1_width, cursor1_height
)
